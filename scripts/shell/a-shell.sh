...
#   de DevDeb. Es el primer script que se ejecuta en la instalación de terminal
#   (de ahí el prefijo 'a-').
#
...
#
# Funcionalidades de la configuración de DevDeb:
#   - Aliases útiles
...
#   - Copia configuraciones de DevDeb
...
# Configurar el shell Bash usando configuraciones predeterminadas de DevDeb

# Si existe un .bashrc previo, hacer respaldo
[ -f ~/.bashrc ] && mv ~/.bashrc ~/.bashrc.bak

# Copiar la configuración de bashrc de DevDeb
...
# Configurar inputrc usando configuraciones predeterminadas de DevDeb
